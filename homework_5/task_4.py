...
def scrabble(word):
    """
    подсчет отчков за букв в строке

    :param word: входная строка
    :return: points - число очков за все буквы
    """
    # словарь очков для букв
    word_point = {1: 'авеёинорст', 2: 'дклмпу', 3: 'бгья',
                      4: 'йы', 5: 'жзхцч', 8: 'фшэю', 10: 'щ', 15: 'ъ'}
    points = 0
    for i in word:
        for n, m in word_point.items():
            if i in m:
                points += n
