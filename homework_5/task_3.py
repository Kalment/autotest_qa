...
def everything_for_your_cat(cats_data):
    """
    преобразование списка кортежей в строку с уменьшением записей при повторении фио

    :param cats_data: список кортежей
    :return: our_str - строка вида словаря, где при повторении ключа - значениея записаны в уже имеющийся ключ
    """
