...
def treatment_sum(our_tuple):
    '''
    функция для проверки озможности складывать элементы кортежа
    :param our_tuple: кортеж с данными
    :return: вывод результата сложения элементов кортежа
    '''

    # Проверка кортежа на большое количество данных
    if len(our_tuple) > 2:
