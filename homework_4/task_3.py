...
def sum_digits(num):
    ...
    :return: our_sum - сумма цифр исходного числа
    """

    our_sum = 0  # инициализируем сумму
    for i in range(len(str(num))):  # проходим по строке и сразу же суммируем все цифры
        our_sum += int(str(num)[i])
